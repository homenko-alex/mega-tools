                ...
                <div class="topbar__container container">
                    ...
                    <div class="topbar__row">
                        <div class="topbar__item topbar__item--link">
							<?= _e( 'Интернет магазин электроинструмента', 'mega-tools' ) ?>
                        </div>
                        ...
                        <div class="topbar__item">
                            ...
                            <div class="topbar-dropdown">
                                <button class="topbar-dropdown__btn" type="button">
									<?= _e( 'Язык', 'mega-tools' ) ?>: <span class="topbar__item-value text-uppercase"><?= $currentLang ?></span>
                        ...
                        <div class="search__body">
                            <form class="search__form" action="<?= home_url() ?>">
                                <select class="search__categories" aria-label="Category">
                                    <option value="all"><?= _e( 'Все категории', 'mega-tools' ) ?></option>
									<?php
									if( $categories )
									{
